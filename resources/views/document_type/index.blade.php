            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <a href="{{route('document_type.create')}}" class="btn btn-success pull-right"><span class="fa fa-plus"></span> Nuevo</a>
                    </div>
                    <div class="box-body">
        ...
        $(function () {
            $('#table').DataTable({
                ...
                language : {
                    ...
                    "sInfo":           "Mostrando del _START_ al _END_ de un total de _TOTAL_ tipos de documentos",
